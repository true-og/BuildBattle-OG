...
public class PlaceholderInitializer {
    ...
    private void registerPlaceholders() {
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("theme", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
                    ...
                    private String getTheme(Player player, IPluginArena arena) {
                        ...
                        if (theme.equalsIgnoreCase(new MessageBuilder("SCOREBOARD_THEME_UNKNOWN").asKey().build())) {
                            ...
                            if (((GuessArena) pluginArena).getCurrentBuilders().contains(player)
                                    || ((GuessArena) pluginArena).getWhoGuessed().contains(player))
                {

                                GuessTheme guessTheme = ((GuessArena) pluginArena).getCurrentBBTheme();
                                theme = guessTheme == null
                                        ? new MessageBuilder("SCOREBOARD_THEME_UNKNOWN").asKey().build()
                                        : guessTheme.getDefaultTheme();
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("difficulty", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
        ...
        placeholderManager.registerPlaceholder(new Placeholder("difficulty_points_reward",
                Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
        {
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("builder", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
                    ...
                    private String getBuilder(IPluginArena arena) {
                        ...
                        if (((GuessArena) pluginArena).getBuildPlot() == null
                                || ((GuessArena) pluginArena).getBuildPlot().getMembers().isEmpty())
                {
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("type", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("type_pretty", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
        ...
        for (int i = 1; i <= 32; i++) {
            ...
            final int number = i;
            placeholderManager.registerPlaceholder(new Placeholder("place_member_" + number,
                    Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
            {
                ...
                private String getPlace(IPluginArena arena) {
                    ...
                    if (pluginArena.getArenaInGameState() != BaseArena.ArenaInGameState.PLOT_VOTING
                            && pluginArena.getArenaState() != IArenaState.ENDING)
                    {
                    ...
                    plotRanking.get(number - 1).getMembers()
                            .forEach(player -> members.append(player.getName()).append(" & "));
            ...
            placeholderManager.registerPlaceholder(new Placeholder("place_points_" + number,
                    Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
            {
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("ingame_state", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
        ...
        placeholderManager.registerPlaceholder(new Placeholder("ingame_state_pretty", Placeholder.PlaceholderType.ARENA,
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("teammates", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
        ...
        placeholderManager.registerPlaceholder(new Placeholder("summary_player", Placeholder.PlaceholderType.ARENA,
                Placeholder.PlaceholderExecutor.ALL)
        {
            ...
            private String getSummary(IPluginArena arena, Player player) {
                ...
                if (plot != null && !plot.getMembers().isEmpty() && plot.getMembers().contains(player)) {
                    ...
                    return new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_WIN").asKey().arena(pluginArena)
                            .build();

                }

                return new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_LOSE").asKey().arena(pluginArena)
                        .build();
        ...
        placeholderManager.registerPlaceholder(new Placeholder("summary_place_own", Placeholder.PlaceholderType.ARENA,
                Placeholder.PlaceholderExecutor.ALL)
        {
            ...
            private String getSummary(IPluginArena arena, Player player) {
                ...
                List<Plot> plotRanking = pluginArena.getPlotManager().getTopPlotsOrder();
                List<Plot> potentialPlot = plotRanking.stream().filter(plot -> plot.getMembers().contains(player))
                        .collect(Collectors.toList());
                if (potentialPlot.isEmpty()) {

                    return new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_OWN").asKey().integer(0)
                            .arena(pluginArena).build();
                ...
                return new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_OWN").asKey().integer(plotIndex + 1)
                        .arena(pluginArena).build();
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("summary", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
                    ...
                    private String getSummary(IPluginArena arena) {
                        ...
                        if (plot != null && !plot.getMembers().isEmpty()) {
                            ...
                            return new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_WINNER").asKey()
                                    .arena(pluginArena).build();
        ...
        placeholderManager.registerPlaceholder(new Placeholder("summary_place_list", Placeholder.PlaceholderType.ARENA,
                Placeholder.PlaceholderExecutor.ALL)
        {
            ...
            private String getSummary(IPluginArena arena) {
                ...
                for (int i = 1; i <= places; i++) {
                    ...
                    placeSummary.append("\n")
                            .append(new MessageBuilder("IN_GAME_MESSAGES_GAME_END_PLACEHOLDERS_PLACE").asKey()
                                    .integer(i).value("%arena_place_member_" + i + "% (%arena_place_points_" + i + "%)")
                                    .arena(pluginArena).build());
        ...
        placeholderManager.registerPlaceholder(
                new Placeholder("gtb_rounds", Placeholder.PlaceholderType.ARENA, Placeholder.PlaceholderExecutor.ALL)
                {
                    ...
                    private String getSummary(IPluginArena arena) {
                        ...
                        return String.valueOf(
                                pluginArena.getPlotList().size() * pluginArena.getArenaOption("GTB_ROUNDS_PER_PLOT"));
